...
- DO NOT extract symposium participations, paper presentations, project declarations, workshops attended, seminars attended, or resume declaration statements (such as "I solemnly declare...", "INTELLX-24", "tiny swarm robots", "Kalasalingam Innovation", etc.). These are presentations, academic events, or declarations, NOT professional certifications.
...
6. Check project counts and certification counts. Ensure that certifications contain ONLY valid, verified professional credentials, licenses, or courses. Remove any false positives like symposiums, workshops, seminars, papers presented, "DECLARATION", "SOLUTIONS", signature blocks, headings, or references.
